...
const Card = forwardRef(({element, type, t}, ref) => {
  ...
  return (
      <a href={`/details/${element.media_type  || type || t}/${element.id}`} ref={ref} className={classNames(styles.card, `${theme === 'dark' ? styles.card__dark : styles.card__light}`)} id = {element.id} > 
